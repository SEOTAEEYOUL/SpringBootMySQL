...
Write-Host "docker tag springmysql:${Tag} 143719223348.dkr.ecr.ap-northeast-2.amazonaws.com/springmysql:${Tag}"
docker tag springmysql:${Tag} 143719223348.dkr.ecr.ap-northeast-2.amazonaws.com/springmysql:${Tag}

Write-Host "docker push 143719223348.dkr.ecr.ap-northeast-2.amazonaws.com/springmysql:${Tag}"
docker push 143719223348.dkr.ecr.ap-northeast-2.amazonaws.com/springmysql:${Tag}
